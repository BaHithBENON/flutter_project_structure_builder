...
abstract class AuthenticationRepository {
  ...
  Future<(Failure?, EntityAuthentication?)> getUserOtp({ required String email });
  Future<(Failure?, EntityAuthentication?)> verifyUserOtp({ required String email, required String otp });
  Future<(Failure?, EntityAuthentication?)> verifyUserExistence();
